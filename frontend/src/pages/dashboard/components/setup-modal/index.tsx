                                ...
                                <div className={cx("container")}>
                                    ...
                                    <div className={cx("grid__box")}>
                                        ...
                                        <div className={cx("area__c")}>
                                            ...
                                            >
                                                <p>
                                                    Thiết lập phong cách và
                                                    giọng điệu phản hồi của
                                                </p>
                                                <p>
                                        ...
                                        <div className={cx("area__e")}>
                                            ...
                                            >
                                                <p>
                                                    Chọn các tùy chỉnh bổ sung
                                                    dựa trên phong cách và tông
                                                    giọng cơ bản
                                                </p>
                                                <p>của bạn.</p>
                                            </div>
                                    ...
                                    <div className={cx("memory__top")}>
                                        ...
                                        <div
                                            className={cx("memory__top--right")}
                                        >
                                            Cho phép ChatIZN lưu và sử dụng bộ
                                            nhớ khi phản hồi.
                                        </div>
                                    </div>
                                    <div className={cx("memory__top")}>
                                        ...
                                        <div
                                            className={cx("memory__top--right")}
                                        >
                                            Cho phép ChatIZN tham khảo các cuộc
                                            trò chuyện gần đây khi phản hồi.
                                        </div>
                                    </div>
                                    <div className={cx("memory__bottom")}>
                                        <div className={cx("content")}>
                                            ChatIZN có thể sử dụng Bộ nhớ để cá
                                            nhân hóa các truy vấn theo công cụ
                                            tìm kiếm, như Bing.{" "}
                                    ...
                                    {onButton2 && (
                                        <>
                                            ...
                                            <div className={cx("memory__top")}>
                                                ...
                                                >
                                                    Trò chuyện tự nhiên hơn ở
                                                    chế độ thoại
                                                </div>
                                            </div>
                                            <div
                                                className={cx("memory__top--x")}
                                            >
                                                <div
                                                    className={cx(
                                                        "memory__top--left"
